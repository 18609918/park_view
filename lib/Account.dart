...
class Account extends StatefulWidget {
  Account(this.passedEmail, this.passedID) : super();
...
class _AccountState extends State<Account> {
  ...
  String fname, lname, email, phone, password, emailVal;
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Padding(padding: EdgeInsets.all(8.0),
                          child: Text(widget.passedEmail, style: TextStyle(color: Colors.white),),)
                    ],
                  ),
                )),
  ...
  String validateEmail(String value) {
    ...
    if (emailVal == controllerEmail.text && emailVal != widget.passedEmail) {
